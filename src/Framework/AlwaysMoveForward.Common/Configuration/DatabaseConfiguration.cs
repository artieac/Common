...
namespace PucksAndProgramming.Framework.Common.Configuration
{
    /// <summary>
    /// A class to simplify getting the configuration settings for a database
    /// </summary>
    public class DatabaseConfiguration : PucksAndProgramming.Framework.Common.Encryption.EncryptedConfigurationSection
    {
        /// <summary>
