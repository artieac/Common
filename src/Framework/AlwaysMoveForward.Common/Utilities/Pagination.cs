...
namespace PucksAndProgramming.Framework.Common.Utilities
{
    public static class Pagination
    {
        public static PagedList<T> ToPagedList<T>(this IList<T> source)
        {
            return new PagedList<T>(source, 0, PucksAndProgramming.Framework.Common.Utilities.Constants.PageSize);
        }
